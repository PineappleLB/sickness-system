...
CREATE TABLE `t_sys_area` (
  ...
  `merger_name` varchar(255) DEFAULT NULL COMMENT '合并全称',
  ...
  PRIMARY KEY (`id`)
) COMMENT '中国省市地区表' ENGINE=INNODB CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `t_sys_area` */

insert  into `t_sys_area`(`id`,`parent_id`,`short_name`,`name`,`merger_name`,`level`,`pinyin`,`code`,`zip_code`,`first`,`lng`,`lat`) values
...
(3329,3326,'大安','大安区','中国,台湾,台北市,大安区',3,'daan','02','106','D','121.534648','25.026406'),
...
(3366,3339,'永安','永安区','中国,台湾,高雄市,永安区',3,'yongan','07','828','Y','120.225308','22.818580'),
...
(3408,3386,'大安','大安区','中国,台湾,台中市,大安区',3,'daan','04','439','D','120.58652','24.34607'),
...
(3550,3532,'泰安','泰安乡','中国,台湾,苗栗县,泰安乡',3,'taian','037','365','T','120.904441','24.442600'),
...
(3688,3683,'吉安','吉安乡','中国,台湾,花莲县,吉安乡',3,'jian','03','973','J','121.568005','23.961635'),
...
(3702,3697,'望安','望安乡','中国,台湾,澎湖县,望安乡',3,'wangan','06','882','W','119.500538','23.357531'),
